...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeQuickLookConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QuickLookConfig {
        return
            try QuickLookConfig(
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuickLookConfig_lift(_ buf: RustBuffer) throws -> QuickLookConfig {
    return try FfiConverterTypeQuickLookConfig.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuickLookConfig_lower(_ value: QuickLookConfig) -> RustBuffer {
    return FfiConverterTypeQuickLookConfig.lower(value)
}
...
public enum QuickLookError: Swift.Error {
    ...
    case MarkdownRenderError(message: String
    )
    case TemplateRenderError(message: String
    )
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeQuickLookError: FfiConverterRustBuffer {
    typealias SwiftType = QuickLookError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QuickLookError {
        ...
        case 1: return .FileReadError(
            message: try FfiConverterString.read(from: &buf)
            )
        case 2: return .MarkdownRenderError(
            message: try FfiConverterString.read(from: &buf)
            )
        case 3: return .TemplateRenderError(
            message: try FfiConverterString.read(from: &buf)
            )
        case 4: return .ConfigError(
            message: try FfiConverterString.read(from: &buf)
            )
        case 5: return .InvalidPathEncoding

         default: throw UniffiInternalError.unexpectedEnumCase
        }
    }

    public static func write(_ value: QuickLookError, into buf: inout [UInt8]) {
        switch value {
        ...
        case let .MarkdownRenderError(message):
            writeInt(&buf, Int32(2))
            FfiConverterString.write(message, into: &buf)
            
        
        case let .TemplateRenderError(message):
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuickLookError_lift(_ buf: RustBuffer) throws -> QuickLookError {
    return try FfiConverterTypeQuickLookError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuickLookError_lower(_ value: QuickLookError) -> RustBuffer {
