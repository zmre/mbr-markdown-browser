...
* Plan
  * [x] We have a bug with PDF metadata processing. In a big repo of PDFs, not one has any non-null metadata so we need to figure out why that isn't working and fix it
